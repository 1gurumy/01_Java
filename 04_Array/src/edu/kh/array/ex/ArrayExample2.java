...
import java.util.Arrays; // Array.toString 사용하려면 임포트 해야함.
...
public class ArrayExample2 {
	...
	public void shallowCopy() {
		...
		// 얕은 복사 진행
		int[] copyArr = arr; // arr이 참조하는 주소값만 복사
	...
	public void deepCopy() {
		...
		// 깊은 복사 방법
		// 1. for문을 이용한 깊은 복사
		int[] copyArr1 = new int[arr.length]; // 원본 배열의 길이와 같은 배열을 생성하겠다. -> 5칸짜리 배열 생성
		...
		// 2. System.arraycopy(원본 배열, 원본 복사 시작 인덱스 번호, 
		//					복사할 배열명, 복사 배열의 삽입 시작 인덱스 번호, 복사의 길이);
